...
from api.v1.schemas.settings import SKIDDLE_KEY_MASK, TICKETMASTER_KEY_MASK, EventsSettings
...
def test_put_saves_clears_cache_and_kicks_a_sweep(client, prefs):
    with (
        ...
        response = client.put(
            "/settings/events",
            json={"enabled": True, "ticketmaster_enabled": True,
